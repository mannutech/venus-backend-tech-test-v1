...
export class CreateMarketTable1733000000000 implements MigrationInterface {
  name = 'CreateMarketTable1733000000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS market`);
  }
}
